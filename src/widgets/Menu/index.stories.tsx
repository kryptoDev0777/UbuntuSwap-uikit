...
import { LabelText, StyledUserMenu,StyledNetworkSwtichMenu } from "./components/UserMenu";
import MenuIcon from "./components/UserMenu/MenuIcon";
import { Variant, variants } from "./components/UserMenu/types";
import { links, userMenulinks, networkMenuLinks } from "./config";
...
const NetworkSwitchComponent: React.FC = () => {
  return (
    <DropdownMenu items={networkMenuLinks} py="12px">
      <StyledNetworkSwtichMenu>
        <LabelText title="BSC" >Switch Network</LabelText>
        <ChevronDownIcon color="text" width="24px" />
      </StyledNetworkSwtichMenu>
    </DropdownMenu>
    );
...
const defaultProps = {
  ...
  networkSwitchMenu: <NetworkSwitchComponent />,
  activeItem: "/swap",
  activeSubItem: "https://exchange.pancakeswap.finance",
  buyCakeLabel: "Buy UBUT",
};
